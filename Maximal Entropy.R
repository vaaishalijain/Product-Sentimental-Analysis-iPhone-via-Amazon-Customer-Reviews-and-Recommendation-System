...
pos = scan('F:/Padhai/Data Mining/Minor 2/positive-words.txt', what='character', comment.char=';')
pos = c(pos, 'upgrade', 'awsum')
neg = scan('F:/Padhai/Data Mining/Minor 2/negative-words.txt', what='character', comment.char=';')
